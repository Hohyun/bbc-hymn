...
tenor = \fixed c {
  ...
  c8[ d] ef[ f] | g2. s4 | s1 | s1 |s1 | s1 |
  s1 | s2. a8[ bf] | s2. d'8[ ef'] | s1 | s1 | s2. 
}
  ...
  \score { 
    <<
      \new ChoirStaff <<
        ...
        \context Lyrics = "LyrOne" \lyricsto "alignerba" { \verseOneB }
        ...
        \context Lyrics = "LyrTwo" \lyricsto "alignerbb" { \verseTwoB }
