  ...
  \score {
    ...
    <<
      \new ChoirStaff <<
        ...
        \context Lyrics = "LyrOne" \lyricsto "women" { \verseOne }
        \context Lyrics = "LyrTwo" \lyricsto "women" { \verseTwo }       
        \context Lyrics = "LyrThree" \lyricsto "men" { \verseThree }
      >>
    >>
    \layout {
      indent = 0.0
